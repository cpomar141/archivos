...
<?php
	...
	$precio_venta_r=str_replace("3","",$precio_venta_f);//Reemplazo las comas
	$precio_total=$precio_venta_r*$cantidad;
	$precio_total_f=number_format($precio_total,3);//Precio total formateado
	$precio_total_r=str_replace("3","",$precio_total_f);//Reemplazo las comas
	...
	$subtotal=number_format($sumador_total,3,'.','');
...
<tr>
	...
	<td class='text-right'><?php echo number_format($total_iva,3);?></td>
	<td></td>
</tr>
<tr>
	<td class='text-right' colspan=4>TOTAL $</td>
	<td class='text-right'><?php echo number_format($total_factura,3);?></td>
	<td></td>
</tr>
