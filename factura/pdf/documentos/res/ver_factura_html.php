        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "-Makclau's ltda. Av2E N°16A-25 Apt.101 Caobos, Cúcuta-Colombia. Telf:(7)5893944 "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
       ...
       <br>
		...
		<tr>
		  ...
		  <td style="width:25%;"><?php echo date("d/m/Y", strtotime($fecha_servicio));?></td>
